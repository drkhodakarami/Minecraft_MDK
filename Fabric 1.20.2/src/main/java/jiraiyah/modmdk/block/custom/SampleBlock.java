package jiraiyah.modmdk.block.custom;
...
/*
public class SampleBlock extends BlockWithEntity
{
    public static final Identifier ID = new Identifier(Reference.MOD_ID, "gem_cleanser");
...
/*if (!world.isClient)
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved)
    {
        if (state.getBlock() != newState.getBlock())
        {
            ...
            if (blockEntity instanceof SampleBE)
            {
                ItemScatterer.spawn(world, pos, (SampleBE) blockEntity);
