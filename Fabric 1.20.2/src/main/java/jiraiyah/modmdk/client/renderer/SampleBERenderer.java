package jiraiyah.modmdk.client.renderer;
...
/*
public class SampleBERenderer implements BlockEntityRenderer<SampleBE>
{
    public SampleBERenderer(BlockEntityRendererFactory.Context context)
    {
    }

    @Override
    public void render(SampleBE entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay)
    {
        ...
        matrices.push();
        {
            ...
            switch (entity.getCachedState().get(SampleBlock.FACING))
            {
