package jiraiyah.modmdk.fluid.custom;
...
/*
public abstract class SampleFluid extends FlowableFluid
{
    @Override
    ...
    public static class Flowing extends SampleFluid
    {
        @Override
    ...
    public static class Still extends SampleFluid
    {
        @Override
        public int getLevel(FluidState state)
        {
