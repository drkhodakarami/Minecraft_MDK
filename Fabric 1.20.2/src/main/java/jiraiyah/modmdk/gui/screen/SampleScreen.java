package jiraiyah.modmdk.gui.screen;

import jiraiyah.modmdk.utils.fluid.FluidStack;
import jiraiyah.modmdk.utils.fluid.FluidStackRenderer;
import jiraiyah.modmdk.utils.screen.MouseUtil;
...
/*
public class SampleScreen extends CottonInventoryScreen<SampleScreenDescription>
{
    //private FluidStackRenderer fluidStackRenderer;
    private SampleScreenDescription container;

    public SampleScreen(SampleScreenDescription container, PlayerEntity player, Text title)
    {
