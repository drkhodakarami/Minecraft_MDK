...
/*
public class SampleCategory implements DisplayCategory<BasicDisplay>
{
    public static final Identifier TEXTURE =
            Reference.id("textures/gui/container/gem_cleanser.png");

    public static final CategoryIdentifier<SampleDisplay> GEM_CLEANSER =
            CategoryIdentifier.of(Reference.MOD_ID, "gem_cleanser");
